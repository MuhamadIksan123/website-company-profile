                ...
                <a href="{{ route('front.team') }}" class="view-all-card">
                    <div
                        ...
                        <div class="flex flex-col gap-1 text-center">
                            ...
                            <p class="text-cp-light-grey">Orang Terbaik Kami</p>
                        </div>
                    </div>
                </a>
            </div>
        ...
        <div class="container max-w-[1000px] mx-auto">
            <div class="flex flex-col lg:flex-row gap-[50px] sm:gap-[70px] items-center">
                <div class="flex flex-col gap-[30px]">
                    ...
                    <a href="contact.html" class="p-5 bg-cp-black rounded-xl text-white w-fit font-bold">Hubungi Kami</a>
                </div>
                <div class="flex flex-col gap-[30px] sm:w-[603px] shrink-0">
                    <div class="flex flex-col p-5 rounded-2xl bg-white w-full">
                        <button class="accordion-button flex justify-between gap-1 items-center"
                            ...
                            <span class="font-bold text-lg leading-[27px] text-left">Apakah cicilan dapat menguntungkan
                                kedua belah pihak?</span>
                        ...
                        <div id="accordion-faq-1" class="accordion-content hide">
                            <p class="leading-[30px] text-cp-light-grey pt-[14px]">Kami ingin memastikan bahwa kedua belah
                                pihak mendapatkan manfaat maksimal dari sistem cicilan ini, dengan perlindungan yang optimal
                                untuk aset kami dan klien.</p>
                        </div>
                    </div>
                    <div class="flex flex-col p-5 rounded-2xl bg-white w-full">
                        <button class="accordion-button flex justify-between gap-1 items-center"
                            data-accordion="accordion-faq-2">
                            <span class="font-bold text-lg leading-[27px] text-left">Framework apa yang paling populer di
                                antara Anda?</span>
                            <div class="arrow w-9 h-9 flex shrink-0">
                                <img src="{{ asset('assets/icons/arrow-circle-down.svg') }}"
                                    class="transition-all duration-300" alt="icon">
                        ...
                        <div id="accordion-faq-2" class="accordion-content hide">
                            <p class="leading-[30px] text-cp-light-grey pt-[14px]">Kami memilih framework yang telah
                                terbukti handal dan efisien, dengan keunggulan yang dapat memberikan nilai lebih untuk
                                proyek-proyek kami.</p>
                        </div>
                    </div>
                    <div class="flex flex-col p-5 rounded-2xl bg-white w-full">
                        <button class="accordion-button flex justify-between gap-1 items-center"
                            data-accordion="accordion-faq-3">
                            <span class="font-bold text-lg leading-[27px] text-left">Penyedia asuransi apa yang Anda
                                gunakan?</span>
                            <div class="arrow w-9 h-9 flex shrink-0">
                                <img src="{{ asset('assets/icons/arrow-circle-down.svg') }}"
                                    class="transition-all duration-300" alt="icon">
                        ...
                        <div id="accordion-faq-3" class="accordion-content hide">
                            <p class="leading-[30px] text-cp-light-grey pt-[14px]">Kami bekerja sama dengan penyedia
                                asuransi terpercaya untuk memberikan perlindungan maksimal pada setiap proyek, sehingga
                                klien kami merasa aman selama dan setelah pembangunan.</p>
                        </div>
                    </div>
                    <div class="flex flex-col p-5 rounded-2xl bg-white w-full">
                        <button class="accordion-button flex justify-between gap-1 items-center"
                            data-accordion="accordion-faq-4">
                            <span class="font-bold text-lg leading-[27px] text-left">Bagaimana jika kami memiliki
                                pertanyaan lain?</span>
                            <div class="arrow w-9 h-9 flex shrink-0">
                                <img src="{{ asset('assets/icons/arrow-circle-down.svg') }}"
                                    class="transition-all duration-300" alt="icon">
                            </div>
                        ...
                        <div id="accordion-faq-4" class="accordion-content hide">
                            <p class="leading-[30px] text-cp-light-grey pt-[14px]">Jika Anda memiliki pertanyaan lebih
                                lanjut, kami siap memberikan penjelasan lebih detail dan memastikan setiap kebutuhan Anda
                                dipenuhi dengan baik.</p>
                        </div>
                    </div>
                </div>
            </div>
